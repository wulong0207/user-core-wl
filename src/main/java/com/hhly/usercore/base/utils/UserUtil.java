...
public class UserUtil {
	...
	public Integer getUserIdByToken(String token) {
		return redisUtil.getObj(getTokenKey(token), Integer.class);
	}
	...
	public UserInfoBO getUserByToken(String token) {
		Integer userId = redisUtil.getObj(getTokenKey(token), Integer.class);
		if (userId == null) {
			return null;
		}
		UserInfoBO userInfoBO = redisUtil.getObj(getUserKey(userId), UserInfoBO.class);
		if (userInfoBO == null) {
	...
	public UserInfoBO getUserById(Integer userId) {
		return redisUtil.getObj(getUserKey(userId), UserInfoBO.class);
	}
